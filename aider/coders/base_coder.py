...
TEST_ERROR_REFLECTION_GUIDANCE = (
    ...
    "throws clauses, helper classes, coordinate origin/order, and behavior. "
    "Do not repeat the previous implementation unchanged; make a material "
    "correction that addresses the reported mismatch without reconstructing, "
    "inventing, or quoting full test files. When a compiler reports a duplicate "
    "class, reuse the existing sibling class instead of declaring another one. "
    "When expected/actual values print as opaque object hashes, use nearby "
    "expected constructors and value-object helpers to infer fields such as "
    "coordinate origin and order. Match the failing assertion entry point, "
